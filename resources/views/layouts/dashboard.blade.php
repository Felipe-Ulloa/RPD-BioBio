      ...
      <li class="nav-item">
        ...
        <div id="delete" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            @endcan  
            @can('receptions.delete')
            <a class="collapse-item" href="{{ url ('lotes/delete') }}">Productos Palletizado</a>
            ...
            @endcan
             @can('receptions.delete')
            <a class="collapse-item" href="{{ url ('reprocesses/delete') }}">Reproceso</a>

            @endcan 
              @can('receptions.delete')
            <a class="collapse-item" href="{{ url ('subreprocesses/delete') }}">P/R sin Terminar</a>
