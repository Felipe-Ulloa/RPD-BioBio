...
Route::middleware('auth')->group(function () {
 ...
 Route::post('/camaraFruitSearch', 'ReportesController@reporteCamaraFruitSearch')->name('reporteCamaraFruitSearch')->middleware('permission:receptions.receptionsdaily');  
    ...
    // reproceso
 Route::get('/reprocesses/delete', 'ReprocessController@delete')->name('process.reprocesses.delete')
        ->middleware('permission:receptions.delete'); 
    ...
    Route::get('/subprocess/delete', 'SubProcessController@delete')->name('subprocess.delete')->middleware('permission:subprocess.index');
    ...
    Route::post('/dispatch/store', 'DispatchController@store')->name('dispatch.store')->middleware('permission:dispatch.index');
     ...
     Route::get('/dispatch/delete', 'DispatchController@delete')->name('dispatch.delete')->middleware('permission:dispatch.delete');
